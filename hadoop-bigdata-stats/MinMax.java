...
public class MinMax {
	...
	public static class CategoryMinMaxMapper extends Mapper<Object, Text, Text, Text> {
	...
	public static class BrandMinMaxMapper extends Mapper<Object, Text, Text, Text> {
	...
	public static class EventMinMaxMapper extends Mapper<Object, Text, Text, Text> {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		System.out.println("MinMax Mode");
		Configuration conf = new Configuration();
		Job job = Job.getInstance(conf, "find min-max");
		job.setJarByClass(MinMax.class);
		if (Integer.parseInt(args[0]) == 1) {
			//Category
			job.setMapperClass(CategoryMinMaxMapper.class);
		} else if (Integer.parseInt(args[0]) == 2) {
			//Brand
			job.setMapperClass(BrandMinMaxMapper.class);
		} else {
			//Event
			job.setMapperClass(EventMinMaxMapper.class);
		}
